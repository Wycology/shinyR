...
library(shinythemes) # For changing themes.

# Load the necessary data-sets for the project 

data(iris) # iris flower data having five variables and 150 observations
...
)) # fluidpage ends here and server begins


# Defining server function, just server
...
# create shiny object using the shinyApp function
